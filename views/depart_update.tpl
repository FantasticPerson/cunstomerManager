...
<body>
	<div class="contentBox">
		<form id="dataform" name="dataform" enctype="multipart/form-data" method="post" action="">
			...
			<fieldset>
				<legend class="legend">修改部门</legend>
				<table width="99%" border="0" align="center" cellpadding="0"
					cellspacing="0" class="contentTable">
					<tr>
						<td width="20%" height="35" align="right">部门名称：</td>
						<td width="30%"><input type="text" class="textInput width_205" id="deptName" name="deptName" value="{{.deptname}}"></td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">部门排序：</td>
						<td><input type="text" class="textInput width_205" id="deptIndex" name="deptIndex" value="{{.deptindex}}">
						</td>
						<td></td>
					</tr>
				</table>
...
function saveDept(){
	...
	var gUrl = '{{.baseurl}}/depart/create.do?pid='+deptId+'&model='+1+'&name='+deptName+'&departIndex='+deptIndex;

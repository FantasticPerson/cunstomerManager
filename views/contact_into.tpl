...
<html>
  ...
  <body>
    ...
    <div class="container bs-docs-container">
        <div role="main">
          <div class="btn-group"><a href="{{.baseurl}}/depart/show.do" type="button" class="btn btn-primary"><i class="glyphicon glyphicon-circle-arrow-left"></i> 返回</a></div>
          <!-- Getting started ================================================== -->
          <form id="dataform" name="dataform" class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="{{.baseurl}}/contacts/saveXLSX.do">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="col-sm-2 control-label">版本名称</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="vname" name="VersionName" value="{{.data.VersionName}}" readonly>
                  </div>
                </div>

...
<body>
	<div class="contentBox">
		<form id="dataform" name="dataform" enctype="multipart/form-data" method="post" action="">
			<fieldset>
				<legend class="legend">修改联系人</legend>
				<table width="99%" border="0" align="center" cellpadding="0"
					cellspacing="0" class="contentTable">
					<tr>
						<td width="20%" height="35" align="right">IM用户名:</td>
						<td width="30%"><input type="text" class="textInput width_205" id="Uname" name="Uname" value="{{.data.Uname}}" ></td>
						<td></td>
					</tr>
					<tr>
						<td width="20%" height="35" align="right">姓名：</td>
						<td width="30%"><input type="text" class="textInput width_205" id="Name" name="Name" value="{{.data.Name}}" placeholder="  --姓名必填"></td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">部门：</td>
						<td><input type="text" class="textInput width_205" id="Depart" name="Depart" value="{{.dname}}" readonly placeholder="  --部门必填" onclick="chooseDepart();">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">职位：</td>
						<td><input type="text" class="textInput width_205" id="Job" name="Job" value="{{.data.Job}}" >
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">邮箱：</td>
						<td><input type="text" class="textInput width_205" id="Mail" name="Mail" value="{{.data.Mail}}" >
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">手机号码1：</td>
						<td><input type="text" class="textInput width_205" id="Mobile1" name="Mobile1" value="{{.data.Mobile1}}">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">短号1：</td>
						<td><input type="text" class="textInput width_205" id="ShortMobile1" name="ShortMobile1" value="{{.data.ShortMobile1}}">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">手机号码2：</td>
						<td><input type="text" class="textInput width_205" id="Mobile2" name="Mobile2" value="{{.data.Mobile2}}">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">短号2：</td>
						<td><input type="text" class="textInput width_205" id="ShortMobile2" name="ShortMobile2" value="{{.data.ShortMobile2}}">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">手机号码3：</td>
						<td><input type="text" class="textInput width_205" id="Mobile3" name="Mobile3" value="{{.data.Mobile3}}">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">短号3：</td>
						<td><input type="text" class="textInput width_205" id="ShortMobile3" name="ShortMobile3" value="{{.data.ShortMobile3}}">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">办公室电话：</td>
						<td><input type="text" class="textInput width_205" id="Officetel" name="Officetel" value="{{.data.Officetel}}" placeholder="区号-电话号码(-分机号)">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">部门内排序：</td>
						<td><input type="text" class="textInput width_205" id="Userindex" name="Userindex" value="{{.data.Userindex}}">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">家庭电话：</td>
						<td><input type="text" class="textInput width_205" id="Hometel" name="Hometel" value="{{.data.Hometel}}">
						</td>
						<td></td>
					</tr>
					<tr>
						<td height="35" align="right">传真：</td>
						<td><input type="text" class="textInput width_205" id="Fax" name="Fax" value="{{.data.Fax}}">
						</td>
						<td></td>
					</tr>
					<tr>
